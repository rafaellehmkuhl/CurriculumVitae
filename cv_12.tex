...
\descript{Bachelor's Degree in \\ mechanical engineering}
\location{2012 - 2019}
\vspace*{0.2cm}
\subsection{Sapienza}
...
\descript{\\ \textit{Product Development Engineering Internship}}
...
\runsubsection{Lecture course}
\descript{\\ PCB Design with Eagle}
...
\sectionspace % Some whitespace after the section
\runsubsection{Lecture course}
\descript{\\ Introduction to Python}
\location{November 2018}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
...
%\runsubsection{Porous Medium and Thermophysical Properties Lab - UFSC}
